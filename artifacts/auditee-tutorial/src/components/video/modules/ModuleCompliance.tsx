...
const story = getStory('compliance');
...
const frameworks = [
  { name: 'HIPAA', pct: 89, color: '#a78bfa' },
  { name: 'HITRUST CSF', pct: 81, color: '#38bdf8' },
  { name: 'ISO 27001', pct: 76, color: '#34d399' },
  { name: 'SOC 2', pct: 88, color: '#fb923c' },
  { name: 'FHIR R4', pct: 92, color: '#c084fc' },
];
...
export function ModuleCompliance() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[var(--color-bg-dark)] font-display text-white">
      <BackgroundMusic />
      <AppShell slug="compliance" story={story} currentScene={currentSceneKey} />
