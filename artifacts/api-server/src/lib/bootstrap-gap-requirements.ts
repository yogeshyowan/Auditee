...
const PROJECT = {
  ...
  name: "Auditee — Platform Capabilities Roadmap",
  slug: "platform",
  description:
    "Gap analysis vs. SafetyCulture iAuditor, Praxie, ReportGPT, and Process Street. Tracks capabilities Auditee must add to reach feature parity with adjacent inspection, work-management, AI-reporting, and workflow tools.",
  owner: "Product",
  complianceScore: 0,
};
