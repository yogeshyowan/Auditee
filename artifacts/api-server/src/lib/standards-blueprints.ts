...
export const STANDARDS_BLUEPRINTS: StandardsBlueprint[] = [
  ...
  {
    label: "ISO/SAE 21434 (Automotive Cybersecurity)",
    matches: (t) => has(t, "iso21434", "isosae21434", "sae21434"),
    documentSections: [
      "Cybersecurity goals derived from TARA results (assets → threat scenarios → impact → attack feasibility → risk values → treatment)",
      "Cybersecurity concept allocating goals to functional and technical cybersecurity requirements at the item and component level",
      "Cybersecurity case argument with linked evidence supporting release-for-post-development",
      "Cybersecurity Interface Agreement (CIA) where activities are distributed to suppliers",
      "Vulnerability monitoring, analysis and management process operating throughout the lifecycle",
      "Incident response plan covering detection, containment, remediation, communication and post-incident analysis",
    ],
    requirementCoverage: [
      "Item definition including boundary, functions, preliminary architecture and operational environment",
      "Asset identification with cybersecurity properties (confidentiality, integrity, availability, authenticity, authorisation, non-repudiation)",
      "Threat scenario identification (e.g. STRIDE) and damage scenario linkage",
      "Attack path analysis and attack feasibility rating",
      "Risk value determination and treatment decision per asset/scenario",
      "Cybersecurity validation evidence at the vehicle level",
    ],
    citationHint: "Cite clause numbers (e.g. 9.4 cybersecurity goals, 15.5 impact rating, 15.8 risk value) and reference TARA artefacts.",
  },
  {
    label: "ISO 13849 (Machinery Safety)",
    matches: (t) => has(t, "iso13849", "en13849"),
    documentSections: [
      "Safety functions list with required Performance Level (PLr) per function and S/F/P justification",
      "Architecture per safety function (Category B/1/2/3/4) with redundancy and diagnostic coverage analysis",
      "MTTFD per channel, DCavg, CCF score (Annex F checklist) and resulting achieved PL",
      "Software safety lifecycle artefacts for SRESW and SRASW per Cl. 7",
      "Validation plan and validation report per ISO 13849-2",
    ],
    requirementCoverage: [
      "Safety function specification (input devices, logic, output devices, response time, fault behaviour)",
      "Required Performance Level (PLr) determination using S/F/P decision graph",
      "Defensive programming and modular software structure for SRESW/SRASW",
      "Periodic test, maintenance and information for use that preserve PL over the device lifetime",
      "Common cause failure mitigations scoring ≥65 for Categories 2/3/4",
    ],
    citationHint: "Cite ISO 13849-1 clause numbers and Annex (e.g. Annex A for PLr, Annex F for CCF, Annex G for systematic failures).",
  },
  {
    label: "EN 50128 (Railway Software)",
    matches: (t) => has(t, "en50128", "iec62279", "iec50128"),
    documentSections: [
      "Software Safety Integrity Level (SWSIL 0–4) allocation and rationale per software function",
      "V-model lifecycle artefacts: Software Requirements Spec, Architecture, Component Design, Coding Standards, Component/Integration/Overall Validation reports",
      "Tool classification (T1/T2/T3) and qualification evidence per Cl. 6.7",
      "Software Quality Assurance Plan, Software Configuration Management Plan and Software Verification Plan",
      "Independence matrix showing personnel separation between development and verification/validation/assessment per SWSIL",
    ],
    requirementCoverage: [
      "Software safety requirements traceable from system safety requirements down to component design and back through tests",
      "Coding standards: language subset, naming, complexity limits, defensive programming, run-time error handling",
      "Unit test coverage per SWSIL (statement → branch → MC/DC) with coverage measurement evidence",
      "Application data lifecycle (preparation, verification, validation, deployment, maintenance)",
      "Pre-existing/COTS/legacy software assessment with compensating measures",
    ],
    citationHint: "Cite EN 50128 clause numbers (e.g. 7.2 software requirements, 7.7 overall validation, 6.7 tool qualification, 9.3 pre-existing software).",
  },
  {
    label: "ISO/IEC/IEEE 42010 (Architecture Description)",
    matches: (t) => has(t, "iec42010", "ieee42010", "isoiecieee42010"),
    documentSections: [
      "Stakeholder list with their architecturally significant concerns",
      "Architecture viewpoints catalogue (name, concerns framed, model kinds, languages, conventions)",
      "Architecture views — exactly one view per declared viewpoint, conforming to its viewpoint conventions",
      "Architecture decisions register with rationale, alternatives considered and trade-offs",
      "Correspondence rules linking views, models and architecture-to-implementation elements",
    ],
    requirementCoverage: [
      "Identification of system-of-interest and its architecture description scope",
      "Each architectural concern explicitly assigned to at least one viewpoint that addresses it",
      "Models within each view conforming to the model kinds prescribed by the viewpoint",
      "Architecture rationale captured with linked evidence (analyses, prototypes, trade studies)",
    ],
    citationHint: "Cite ISO/IEC/IEEE 42010 clause numbers (e.g. 5.2 stakeholders/concerns, 5.3 viewpoints, 5.4 views, 5.6 rationale).",
  },
  {
    label: "IEEE 1016 (Software Design Descriptions)",
    matches: (t) => has(t, "ieee1016"),
    documentSections: [
      "SDD identification block (system, version, date, status, authority, references, sponsor, abbreviations)",
      "Stakeholder/concern register with the SDD elements that address each concern",
      "Design viewpoints used (Context, Composition, Logical, Information, Interface, Structure, Interaction, Algorithm) and the views produced",
      "Design entities, relationships and attributes presented per the chosen viewpoint conventions",
      "Design rationale narrative tied to architecturally significant decisions",
    ],
    requirementCoverage: [
      "Decomposition of the design into entities with names, types, purposes, functions, subordinates, dependencies, interface, processing and data",
      "Interface specifications: operations, parameters, exceptions, protocols, quality attributes",
      "Data structures and information stores with schemas and access patterns",
      "Interaction sequences for each main scenario / use case",
    ],
    citationHint: "Cite IEEE 1016 viewpoint annexes (e.g. Annex C.1 Context, C.2 Composition, C.7 Interface, C.9 Interaction).",
  },
  {
    label: "IEEE 1063 (Software User Documentation)",
    matches: (t) => has(t, "ieee1063"),
    documentSections: [
      "Audience analysis (intended users, prior experience, environment, goals)",
      "Documentation set inventory (printed, electronic, embedded help, instructional, reference)",
      "Procedural sections written as numbered steps with results and decision points",
      "Warning / caution / note conventions applied consistently with standardized symbols",
      "Navigation aids: table of contents, index, glossary, search, cross-references as hyperlinks",
    ],
    requirementCoverage: [
      "Completeness against the user task list (install, operate, administer, maintain, dispose)",
      "Accuracy verified against the implemented (not specified) software for each release",
      "Accessibility considerations for electronic documentation",
      "Visual design using consistent typography, headings, lists, tables, figures and icons",
    ],
    citationHint: "Cite IEEE 1063-2001 clause numbers (e.g. 4.1 audience, 5.1 completeness, 6.6 warnings, 6.7 procedures).",
  },
  {
    label: "IEEE 828 (Configuration Management)",
    matches: (t) => has(t, "ieee828"),
    documentSections: [
      "CM Plan covering identification, change control, status accounting, audits, release/delivery, library and supplier control",
      "Configuration item list with naming convention and baseline schedule",
      "Change-control workflow (request → evaluation → CCB decision → implementation → verification → record)",
      "Audit plan for Functional and Physical Configuration Audits at baseline release points",
      "CM tooling description (capabilities, limitations, qualification status)",
    ],
    requirementCoverage: [
      "Unique identification of every configuration item including version and source revision",
      "Change-request lifecycle from submission through closure with traceability to affected CIs and tests",
      "Status accounting reports available to project stakeholders on demand",
      "Library structure (development, controlled, master) with access controls and reproducible builds",
    ],
    citationHint: "Cite IEEE 828 clause numbers (e.g. 5.2 identification, 5.3 change control, 5.4 status accounting, 5.5 audits).",
  },
  {
    label: "IEEE 1012 (Verification & Validation)",
    matches: (t) => has(t, "ieee1012"),
    documentSections: [
      "Integrity Level (1–4) assignment per system / software / hardware item with consequence-of-failure justification",
      "V&V Plan covering organisation, schedule, methods, criteria and reporting per lifecycle phase",
      "V&V activities by phase (Concept, Requirements, Design, Implementation, Test, Installation, Operation, Maintenance) per Annex C",
      "Independence statement (Technical / Managerial / Financial) appropriate to the integrity level",
      "Hazard, security and risk analyses results integrated into V&V activities",
    ],
    requirementCoverage: [
      "Traceability across concept → requirements → design → implementation → tests preserved bidirectionally",
      "Acceptance V&V test plan derived from requirements and aligned with the integrity level",
      "Anomaly evaluation and re-V&V tasks for changes during operation and maintenance",
      "Coverage analyses (statement / branch / MC/DC) consistent with the integrity level",
    ],
    citationHint: "Cite IEEE 1012-2016 clause numbers (e.g. 5.2 integrity-level assignment, 7.x phase tasks, Annex C activities).",
  },
  {
    label: "ISO/IEC/IEEE 29119 (Software Testing)",
    matches: (t) => has(t, "iec29119", "ieee29119", "ieee829", "isoiecieee29119"),
    documentSections: [
      "Organisational test policy and test strategy linked to business objectives",
      "Project test plan, level-specific test plans, status reports and completion report",
      "Test design specifications, test case specifications and test procedure specifications",
      "Test data and test environment requirements with provenance and configuration evidence",
      "Test execution log and test incident (defect) reports tracked through resolution",
    ],
    requirementCoverage: [
      "Risk-based testing prioritisation tying tests to identified product/project risks",
      "Test design technique selection (specification-based, structure-based, experience-based) justified per feature",
      "Coverage criteria definition (requirements, code, risk) with measurement and gap-closure plan",
      "Defect lifecycle: classification, severity, priority, root cause, resolution, verification",
    ],
    citationHint: "Cite ISO/IEC/IEEE 29119 part and clause (e.g. 29119-2 §7 dynamic test process, 29119-3 §6 test management documents, 29119-4 test techniques).",
  },
  {
    label: "IEEE 730 (Software Quality Assurance)",
    matches: (t) => has(t, "ieee730"),
    documentSections: [
      "Software Quality Assurance Plan (SQAP) with the IEEE 730 sections (purpose, scope, refs, management, documentation, standards, reviews/audits, test, problem reporting, tools, code/media/supplier control, records, training, risk)",
      "Product-assurance evaluation records for plans and work products at each lifecycle gate",
      "Process-assurance audit records for lifecycle processes, environment and subcontractors",
      "SQA independence statement and escalation paths to top management",
      "SQA personnel competence evidence (education, training, experience)",
    ],
    requirementCoverage: [
      "Defined criteria SQA uses to evaluate each work product and process",
      "Problem reporting and corrective-action workflow with closure verification",
      "Subcontractor SQA flow-down covering deliverables, audits and joint reviews",
      "Quality records retention schedule and protection from loss/unauthorised access",
    ],
    citationHint: "Cite IEEE 730-2014 clause numbers (e.g. 5.1 SQAP, 5.2 product assurance, 5.3 process assurance, 5.4.2 independence).",
  },
  {
    label: "ISO 9001 (Quality Management)",
    matches: (t) => has(t, "iso9001"),
    documentSections: [
      "Context of the organisation (4.1, 4.2) and QMS scope statement (4.3)",
      "Quality policy and measurable quality objectives with action plans (5.2, 6.2)",
      "Process map showing the QMS processes, sequence and interactions (4.4) with KPIs",
      "Risk-and-opportunities register with planned actions integrated into QMS processes (6.1)",
      "Internal audit programme, management review records and continual improvement actions (9.2, 9.3, 10.3)",
    ],
    requirementCoverage: [
      "Customer-requirement determination, review and change control (8.2)",
      "Design and development controls including planning, inputs, controls, outputs and changes (8.3)",
      "Externally provided processes/products/services controls with supplier evaluation (8.4)",
      "Production and service provision under controlled conditions including release (8.5, 8.6)",
      "Nonconforming output handling and corrective action with root-cause analysis (8.7, 10.2)",
    ],
    citationHint: "Cite ISO 9001:2015 clause numbers (e.g. 4.1 context, 6.1 risks/opportunities, 8.3 design and development, 9.2 internal audit, 10.2 corrective action).",
  },
  {
    label: "ISO 31000 (Risk Management)",
    matches: (t) => has(t, "iso31000"),
    documentSections: [
      "Risk management policy reflecting the eight ISO 31000 principles (Cl. 4)",
      "Risk management framework: leadership commitment, integration, design, implementation, evaluation, improvement (Cl. 5)",
      "Risk management process applied per topic: scope/context/criteria, identification, analysis, evaluation, treatment, monitoring/review, recording/reporting (Cl. 6)",
      "Roles, authorities, responsibilities and accountabilities for risk management at each organisational level",
      "Communication and consultation plan for internal and external stakeholders across the risk lifecycle",
    ],
    requirementCoverage: [
      "Risk criteria (impact, likelihood scales, risk-acceptance thresholds) tied to organisational objectives",
      "Risk identification covering sources, events, scenarios, controls and their effectiveness",
      "Risk analysis with explicit treatment of uncertainty, sensitivity and confidence",
      "Risk treatment iteration: option selection → planning → implementation → effectiveness assessment → residual risk acceptance",
      "Monitoring and review activities with feedback into framework improvement",
    ],
    citationHint: "Cite ISO 31000:2018 clause numbers (e.g. Cl. 4 principles, 5.4 framework design, 6.4 risk assessment, 6.5 risk treatment, 6.7 recording and reporting).",
  },
];
