...
const TIERS = [
  {
    ...
    blurb: "Solo evaluation of the full PDLC platform on a single project.",
    cta: "Start free",
    ctaHref: "/sign-up",
    highlight: false,
    seatLine: "1 user",
  ...
  return (
    <div className="theme-landing min-h-screen bg-white font-sans text-slate-900">
      <SEO
        ...
        description="Transparent pricing for Auditee. Free tier for solo evaluation, Professional at $25/mo for 4 users, Enterprise at $100/mo for 20 users. Single-tenant deployments, SOC 2 Type II, on-prem and air-gapped options available."
        path="/pricing"
        ...
        jsonLd={[
          faqLd([
            ...
            { q: "How many users does each paid plan support?", a: "Professional ($25/mo) includes up to 4 user seats. Enterprise ($100/mo) includes up to 20 user seats. Owners can invite or remove members at any time from the in-app Billing & Team page." },
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-3 gap-6">
          {TIERS.map((tier) => (
            ...
            >
              ...
              <div className="text-xs font-semibold text-primary mb-4 uppercase tracking-wide">{tier.seatLine}</div>
