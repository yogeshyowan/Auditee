      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            From the first spark of an idea to post-launch governance, EltegraAI connects every phase of the lifecycle.
          </p>
        </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-xl text-slate-600 mb-10">
            Join the enterprise teams using EltegraAI to build faster, safer, and with perfect clarity.
          </p>
    ...
    <footer className="bg-slate-950 py-16 border-t border-slate-900 text-slate-400">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <p>© {new Date().getFullYear()} EltegraAI. All rights reserved.</p>
