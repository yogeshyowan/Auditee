...
async function seed() {
  ...
  const events = [
    ...
    { kind: "code", message: "Linked verifyPatientIdentity to HEL-0001", actor: "Auditee", entityCode: "HEL-0001", offsetMins: 47 },
    { kind: "compliance", message: "SOC 2 control CC8.1 evidence refreshed", actor: "Platform", entityCode: "CC8.1", offsetMins: 92 },
    { kind: "gap", message: "GDPR Art.17 flagged: missing right-to-erasure implementation", actor: "Auditee", entityCode: "Art.17", offsetMins: 145 },
    ...
    { kind: "gap", message: "FDA 21 CFR 11 audit trail control 11.10(e) regressed to gap", actor: "Auditee", entityCode: "11.10(e)", offsetMins: 540 },
